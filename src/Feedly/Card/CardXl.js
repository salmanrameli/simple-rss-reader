...
class CardXl extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        return(
            <div class={`grid-item span-33 cursor-pointer text-white ${this.state.activeLink === this.state.item.id ? "bg-primary" : "bg-red"}`} key={this.state.item.id}>
