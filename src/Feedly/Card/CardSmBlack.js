...
class CardSmBlack extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        return (
            <div class={`grid-item span-21 cursor-pointer text-white ${this.state.activeLink === this.state.item.id ? "bg-primary" : "bg-black"}`} key={this.state.item.id}>
                <div onClick={(e) => this.handleMarkAsRead(e, this.state.item.canonicalUrl, this.state.item.id, true, this.state.item.unread, true,this.state.item.webfeeds ? this.state.item.webfeeds.wordmark !== undefined ? this.state.item.webfeeds.wordmark : this.state.item.webfeeds.logo !== undefined ? this.state.item.webfeeds.logo : null : null)}>
                    ...
                    <h2><span className="title-sm">{this.state.item.title}</span></h2>
                            ...
                            <div className="col-12 col-md-6 col-lg-6 col-xl-6">
                                <div className="desc">
                                    <div className="actions ml-5">
                                        ...
                                        <button type="button" onClick={() => this.openInBrowser(this.state.item.canonicalUrl)} title="Open article in browser" className="pl-2 no-focus browser-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        ...
                                        <button type="button" onClick={() => this.copyUrl(this.state.item.canonicalUrl)} title="Copy URL address" className="pl-2 no-focus url-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            // <div className={`card cursor-pointer px-1 pb-0 pt-5 text-white ${this.state.activeLink === this.state.item.id ? "bg-primary" : "bg-black"}`}>
            ...
            //                 <br />
            //                 <span className="publish-date text-white">{this.state.item.publishedDate}&nbsp;&nbsp;/&nbsp;&nbsp;{this.state.item.publishedTimeDiff}</span>
            //             </h2>
            //         </div>
            //         <footer>
            //             <div className="row">
            //                 <div className="col-12 col-md-7 text-white">
            //                     <div className="text-wite desc blockquote-footer" title={this.state.item.author}><span className="text-white">{this.state.item.author}</span></div>
            //                 </div>
