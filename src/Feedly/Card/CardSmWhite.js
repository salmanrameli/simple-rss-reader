...
class CardSmWhite extends Component {
    ...
    render() {
        return (
            <div class={`grid-item span-21 cursor-pointer ${this.state.activeLink === this.state.item.id ? "text-white bg-primary" : this.state.item.unread === true ? 'text-dark bg-white' : 'text-secondary bg-white'}`} key={this.state.item.id}>
                    ...
                    <div className="info-and-actions">
                        ...
                        <div className="row">
                            <div className="col-12 col-md-6 col-lg-6 col-xl-6 text-white">
                                <div className="desc blockquote-footer text-dark" title={this.state.item.author}>{this.state.item.author}</div>
                            </div>
