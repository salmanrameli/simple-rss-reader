										...
										<div className="desc">
											{item.unread === true ?
												<div className="actions float-right">
													<button type="button" onClick={(e) => this.handleMarkAsRead(e, item.canonicalUrl, item.id, false, true)} title="Mark article as read" className="pl-5">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
															<path d="M20.285 2l-11.285 11.567-5.286-5.011-3.714 3.716 9 8.728 15-15.285z"/>
														</svg>
													</button>
													<button type="button" onClick={() => this.openInBrowser(item.canonicalUrl)} title="Open article in browser" className="pl-5">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
													...
													<button type="button" onClick={() => this.copyUrl(item.canonicalUrl)} title="Copy URL address" className="pl-5">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
												...
												<div className="actions">
													<button type="button" onClick={(e) => this.handleMarkAsUnread(e, item.id)} title="Mark article as unread" className="pl-5">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
